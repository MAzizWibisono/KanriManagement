...
@section('title', 'Kanri | project_manager')
...
<section class="content">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">
        <a href="{{ url('/project_manager/create') }}"> <button type="button" class="btn btn-primary">Add Project Manager</button> </a>
      </h3>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $project_manager->nama_lengkap }}</td>
            <td>{{ $project_manager->email }}</td>
            <td>{{ number_format($project_manager->mandays) }}</td>
            ...
            <td>
              ...
              <a href="{{ url('/project_manager')."/".$project_manager->id."/edit" }}">
